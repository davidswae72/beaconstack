...
import nuxt_plugin_plugin_6183fabe from 'nuxt_plugin_plugin_6183fabe' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_plugin_a7a42c14 from 'nuxt_plugin_plugin_a7a42c14' // Source: .\\vuetify\\plugin.js (mode: 'all')
import nuxt_plugin_workbox_10381cbd from 'nuxt_plugin_workbox_10381cbd' // Source: .\\workbox.js (mode: 'client')
import nuxt_plugin_metaplugin_5065f786 from 'nuxt_plugin_metaplugin_5065f786' // Source: .\\pwa\\meta.plugin.js (mode: 'all')
import nuxt_plugin_axios_01bf1be1 from 'nuxt_plugin_axios_01bf1be1' // Source: .\\axios.js (mode: 'all')
...
import nuxt_plugin_auth_24d10d2f from 'nuxt_plugin_auth_24d10d2f' // Source: .\\auth.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_6183fabe === 'function') {
    await nuxt_plugin_plugin_6183fabe(app.context, inject)
  }

  if (typeof nuxt_plugin_plugin_a7a42c14 === 'function') {
    await nuxt_plugin_plugin_a7a42c14(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_workbox_10381cbd === 'function') {
    await nuxt_plugin_workbox_10381cbd(app.context, inject)
  }

  if (typeof nuxt_plugin_metaplugin_5065f786 === 'function') {
    await nuxt_plugin_metaplugin_5065f786(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_01bf1be1 === 'function') {
    await nuxt_plugin_axios_01bf1be1(app.context, inject)
  }
  ...
  if (typeof nuxt_plugin_auth_24d10d2f === 'function') {
    await nuxt_plugin_auth_24d10d2f(app.context, inject)
  }
