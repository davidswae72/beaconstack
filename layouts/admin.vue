<template>
  <v-app v-if="user" class="grey lighten-3">
        ...
        <v-menu left bottom>
          ...
          <v-list>
            ...
            >
              ...
              <v-list-item-title class="accent--text">Account</v-list-item-title>
            </v-list-item>
    ...
    <v-main class="grey lighten-3 main pb-16">
      <v-card v-if="$nuxt.isOffline" tile flat dark color="accent">
